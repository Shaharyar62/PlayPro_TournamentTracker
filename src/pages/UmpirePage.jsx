...
import UmpireApp from "../components/UmpireApp";
  ...
  if (isJoined) {
    return (
      <div>
        ...
        <UmpireApp tournamentId={tournamentId} matchId={matchId} />
      </div>
    );
  }

  return (
    <div className="umpire-setup">
      <div className="setup-container">
        <h2>🏓 Umpire Setup</h2>
        <p>Enter tournament and match details to start scoring</p>
