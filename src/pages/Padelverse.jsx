...
const Padelverse = () => {
  ...
  const pages = [
    ...
    {
      path: "/home/multi-court-schedule?masterTournamentId=46&courtId=79,80,81,82,83,84,85",
      name: "Multi Court Schedule",
      color: "#2e55b9",
    },

    {
      path: "/home/score-table?tournamentIds=158,159,160,161,162,163,164&groupDisplayTime=5&refreshInterval=10",
      name: "Score Table",
      color: "#2e55b9",
    },
    {
